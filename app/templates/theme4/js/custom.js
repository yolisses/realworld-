if (window.location === window.parent.location) {
  $(function () {
    ...
    $(".menu i.fa, .menu i.fas, .menu i.far, .menu i.fab").css(
      "margin-top",
      "8px",
    );
    $(
      ".menu ul li ul li i.fa, .menu ul li ul li i.far, .menu ul li ul li i.fas, .menu ul li ul li i.fab",
    ).css("margin-top", "5px");
